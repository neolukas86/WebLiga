...
<title><s:text name="mis.equipos"/> - <s:text name="title" /></title>
</head>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
	    ...
	    <div class="menu_central_header_equipo_imagen">
				<h3><s:text name="mis.equipos"/></h3>
			</div>
			</div>
			
	   <div class="menu_central_body sombra rounded-corners"> 
	    <div id="result" class="result ui-widget-content ui-corner-all">
			<jsp:include page="/WEB-INF/pages/display/equipo/EquiposDisplayListarPropios.jsp" />
		</div>
