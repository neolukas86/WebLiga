...
<script type="text/javascript" src="<s:url value="/javascript/mostrarOcultar.js" />" ></script>
			...
			<s:form name="formulario2" action="ConfirmacionRegistroEquipo" method="post" cssClass="form">
			...
			<s:form name="formulario" action="PasswordEquipo" method="post" cssClass="form">
	    		<s:hidden name="id" value="%{id}" />
				<fieldset>
