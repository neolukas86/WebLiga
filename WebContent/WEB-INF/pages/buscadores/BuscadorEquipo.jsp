...
<title><s:text name="buscar.equipo"/> - <s:text name="title" /></title>
...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
	    ...
	    <div class="menu_central_header_buscarEquipo_imagen">
			<h3><s:text name="buscar.equipo"/></h3>
		</div>
		</div>
	    <div class="menu_central_body sombra rounded-corners">
	    
		<s:form id="formulario" action="SearchTeam" method="post" cssClass="form">
		<fieldset>
		<legend><s:text name="buscar.equipo"/></legend>
		    <s:textfield name="nombre" key="firstname" size="20" maxlength="100" />
...
<sj:a
	id="ajaxformlinkBuscadorEquipo"
	formIds="formulario"
	targets="resultEquipos"
	indicator="indicator"
	button="true"
...
<div id="resultEquipos" class="result ui-widget-content ui-corner-all" style="margin:0px 10px; padding-bottom:10px">
</div>
