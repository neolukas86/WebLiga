...
<title><s:text name="register.comunidad"/> - <s:text name="title" /></title>
</head>
  ...
  <div class="body">
    <div class="body_resize">
	    ...
	    <div class="menu_central">
			...
			<div class="menu_central_header_registroComunidad_imagen">
				<h3><s:text name="register.comunidad"/></h3>
			</div>
			</div>
	...
	<s:form name="formulario" action="CrearComunidad" cssClass="form">
	<fieldset>
	
		<legend><s:text name="register.comunidad"/></legend>
	    <s:textfield name="nombre" key="nombre" size="20" maxlength="30" required="true"/>
	    
	    <fieldset>
	    <legend><s:text name="palabra.deportes" /></legend>
	     
		<sj:checkboxlist id="checkbuttonset" list="listaDeportes" name="deportes"/>
		...
		<sj:checkboxlist id="checkbuttonset1" list="listaJuegos" name="juegos"/>
		</fieldset>
		
		<fieldset>
	    <legend><s:text name="palabra.cartas" /></legend>
	     
		<sj:checkboxlist id="checkbuttonset2" list="listaCartas" name="cartas"/>
		</fieldset>
		
		<fieldset>
	    <legend><s:text name="palabra.juegos.mesa" /></legend>
	     
		<sj:checkboxlist  id="checkbuttonset3" list="listaJuegosdemesa" name="juegosdemesa"/>
		</fieldset>
		...
		<td style="padding-right:15px;">
			<s:select key="password.protected" name="passwordProtected" list="listaBoolean" 
				onchange="mostrar_ocultar_elemento_boolean(this,'joinPassword')"/></td>
	    ...
	    <sj:submit button="true" indicator="indicator" key="register.comunidad" 
