    ...
    <div class="body_resize">
	    ...
	    <div class="menu_central">
	    	...
	    	<div class="menu_central_body sombra rounded-corners">
	          	<jsp:include page="/WEB-INF/pages/noticias/index/blog/miniPrimerosPasos.jsp"/>
			    <jsp:include page="/WEB-INF/pages/noticias/index/blog/miniConectate.jsp"/>
			    <jsp:include page="/WEB-INF/pages/noticias/index/blog/miniWebLiga.jsp"/>
